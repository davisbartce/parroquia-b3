...
--
-- Servidor: localhost
-- Tiempo de generación: 07-10-2015 a las 12:22:34
...
('admin', 0, '', NULL, 'N;'),
('ADMINISTRADOR', 2, 'ADMINISTRA EL SISTEMA', '', 'N;'),
...
('ADMINISTRADOR', 'action_asistenciaReporte_reporte'),
('OPERADOR', 'action_asistenciaReporte_reporte'),
('ADMINISTRADOR', 'action_asistencia_admin'),
('OPERADOR', 'action_asistencia_admin'),
('ADMINISTRADOR', 'action_asistencia_create'),
('OPERADOR', 'action_asistencia_create'),
('ADMINISTRADOR', 'action_bautizo_admin'),
('OPERADOR', 'action_bautizo_admin'),
('ADMINISTRADOR', 'action_bautizo_create'),
('OPERADOR', 'action_bautizo_create'),
('ADMINISTRADOR', 'action_bautizo_delete'),
('ADMINISTRADOR', 'action_bautizo_update'),
('OPERADOR', 'action_bautizo_update'),
('ADMINISTRADOR', 'action_bautizo_view'),
('OPERADOR', 'action_bautizo_view'),
('ADMINISTRADOR', 'action_bautizo_viewPrint'),
('OPERADOR', 'action_bautizo_viewPrint'),
('ADMINISTRADOR', 'action_comunion_admin'),
('OPERADOR', 'action_comunion_admin'),
('ADMINISTRADOR', 'action_comunion_create'),
('OPERADOR', 'action_comunion_create'),
('ADMINISTRADOR', 'action_comunion_update'),
('OPERADOR', 'action_comunion_update'),
('ADMINISTRADOR', 'action_comunion_view'),
('OPERADOR', 'action_comunion_view'),
('ADMINISTRADOR', 'action_comunion_viewPrint'),
('OPERADOR', 'action_comunion_viewPrint'),
('ADMINISTRADOR', 'action_confirmacion_admin'),
('OPERADOR', 'action_confirmacion_admin'),
('ADMINISTRADOR', 'action_confirmacion_create'),
('OPERADOR', 'action_confirmacion_create'),
('ADMINISTRADOR', 'action_confirmacion_update'),
('OPERADOR', 'action_confirmacion_update'),
('ADMINISTRADOR', 'action_confirmacion_view'),
('OPERADOR', 'action_confirmacion_view'),
('ADMINISTRADOR', 'action_dashboard_index'),
('OPERADOR', 'action_dashboard_index'),
('ADMINISTRADOR', 'action_libro_admin'),
('OPERADOR', 'action_libro_admin'),
('ADMINISTRADOR', 'action_libro_create'),
('OPERADOR', 'action_libro_create'),
('ADMINISTRADOR', 'action_libro_delete'),
('OPERADOR', 'action_libro_delete'),
('ADMINISTRADOR', 'action_matrimonio_admin'),
('OPERADOR', 'action_matrimonio_admin'),
('ADMINISTRADOR', 'action_matrimonio_create'),
('OPERADOR', 'action_matrimonio_create'),
('ADMINISTRADOR', 'action_matrimonio_update'),
('OPERADOR', 'action_matrimonio_update'),
('ADMINISTRADOR', 'action_matrimonio_view'),
('OPERADOR', 'action_matrimonio_view'),
('ADMINISTRADOR', 'action_matrimonio_viewPrint'),
('OPERADOR', 'action_matrimonio_viewPrint'),
('ADMINISTRADOR', 'action_padre_admin'),
('ADMINISTRADOR', 'action_padre_create'),
('ADMINISTRADOR', 'action_padre_update'),
('ADMINISTRADOR', 'action_padre_view'),
('ADMINISTRADOR', 'action_persona_admin'),
('OPERADOR', 'action_persona_admin'),
('ADMINISTRADOR', 'action_persona_ajaxlistPersonas'),
('OPERADOR', 'action_persona_ajaxlistPersonas'),
('ADMINISTRADOR', 'action_persona_create'),
('OPERADOR', 'action_persona_create'),
('ADMINISTRADOR', 'action_persona_createModal'),
('OPERADOR', 'action_persona_createModal'),
('ADMINISTRADOR', 'action_persona_mini'),
('OPERADOR', 'action_persona_mini'),
('ADMINISTRADOR', 'action_persona_reporte'),
('OPERADOR', 'action_persona_reporte'),
('ADMINISTRADOR', 'action_persona_reporteDashboard'),
('OPERADOR', 'action_persona_reporteDashboard'),
('ADMINISTRADOR', 'action_persona_update'),
('OPERADOR', 'action_persona_update'),
('ADMINISTRADOR', 'action_persona_view'),
('OPERADOR', 'action_persona_view'),
...
(79, 1, 1442544068, 1442565668, 0, '::1', 1, 1442544068, NULL, NULL),
...
(84, 1, 1443884300, 1444100300, 1, '192.168.1.130', 11, 1444075119, NULL, NULL),
(85, 1, 1444141555, 1444357555, 0, '::1', 2, 1444147942, 1444147946, '::1'),
(86, 3, 1444144484, 1444360484, 1, '::1', 1, 1444144484, NULL, NULL),
(87, 4, 1444147955, 1444363955, 1, '::1', 1, 1444147955, NULL, NULL),
(88, 1, 1444147963, 1444363963, 0, '::1', 5, 1444151664, 1444151757, '::1'),
(89, 1, 1444151758, 1444367758, 0, '::1', 1, 1444151758, 1444152620, '::1'),
(90, 1, 1444152622, 1444368622, 1, '::1', 3, 1444230811, NULL, NULL);
...
(1, 'default', NULL, 3600, 10, 1, -1, -1, 0, 0, 0, 0, '', 0, 'OPERADOR', '', 1);
...
(1, NULL, NULL, 1444230811, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
(2, NULL, NULL, NULL, 'invitado', 'invitado', 'nopassword', NULL, 1, 0, 0),
(3, 1444144454, NULL, 1444144484, 'operador1', 'operador1@g.com', 'parroquia1', '8c7dfffe2d052fa1e801baa30a9bff64', 1, 0, 0),
(4, 1444147898, NULL, 1444147955, 'administrador', 'administrasor@g.com', 'adminparroquia', '7f09da39f047e3377f865e5a98540dbb', 1, 0, 0);
