...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . Matrimonio::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo Matrimonio::label(2) ?>    </legend>
