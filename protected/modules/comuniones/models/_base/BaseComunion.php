...
/**
 * This is the model base class for the table "comunion".
 * DO NOT MODIFY THIS FILE! It is automatically generated by AweCrud.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Comunion".
 *
 * Columns in table "comunion" available as properties of the model,
 * and there are no model relations.
 *
 * @property integer $id
 * @property integer $persona_id
 * @property string $fecha_comunion
...
abstract class BaseComunion extends AweActiveRecord {
    ...
    public function attributeLabels() {
        return array(
                ...
                'fecha_comunion' => Yii::t('app', 'Fecha Comunion'),
    ...
    public function search() {
        ...
        $criteria->compare('fecha_comunion', $this->fecha_comunion, true);
