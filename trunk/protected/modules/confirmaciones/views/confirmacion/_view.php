<?php
/** @var ConfirmacionController $this */
...
<div class="view">
        ...
        <?php if (!empty($data->fecha_confirmacion)): ?>
        <div class="field">
            <div class="field_name">
                <b><?php echo CHtml::encode($data->getAttributeLabel('fecha_confirmacion')); ?>:</b>
            </div>
            <div class="field_value">
                <?php echo Yii::app()->getDateFormatter()->formatDateTime($data->fecha_confirmacion, 'medium', 'medium'); ?>
            <br/>
                 <?php echo date('D, d M y H:i:s', strtotime($data->fecha_confirmacion)); ?>
                            </div>
        </div>
