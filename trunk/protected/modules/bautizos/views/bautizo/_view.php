...
<div class="view">
        ...
        <?php if (!empty($data->fecha_bautizo)): ?>
        <div class="field">
            <div class="field_name">
                <b><?php echo CHtml::encode($data->getAttributeLabel('fecha_bautizo')); ?>:</b>
            </div>
            <div class="field_value">
                <?php echo Yii::app()->getDateFormatter()->formatDateTime($data->fecha_bautizo, 'medium', 'medium'); ?>
            <br/>
                 <?php echo date('D, d M y H:i:s', strtotime($data->fecha_bautizo)); ?>
                            </div>
        </div>
        ...
        <?php if (!empty($data->rc_año)): ?>
        <div class="field">
            <div class="field_name">
                <b><?php echo CHtml::encode($data->getAttributeLabel('rc_año')); ?>:</b>
            </div>
            <div class="field_value">
                <?php echo CHtml::encode($data->rc_año); ?>
            </div>
        </div>
