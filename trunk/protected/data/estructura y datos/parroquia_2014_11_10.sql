...
--
-- Servidor: localhost
-- Tiempo de generación: 10-11-2014 a las 08:44:06
...
CREATE TABLE IF NOT EXISTS `bautizo` (
  ...
  `feligreses_de` int(11) DEFAULT NULL,
...
(12, 1, 1415120202, 1415300202, 1, '::1', 8, 1415200974, NULL, NULL),
(13, 1, 1415462827, 1415642827, 1, '192.168.0.4', 6, 1415553637, NULL, NULL);
...
(1, NULL, NULL, 1415553637, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
(2, '1003117940', 'David', 'Paredes', '1988-09-21', 'Otavalo'),
...
(11, '5212102', 'awdasd', 'iojl', '2014-11-13', NULL),
(12, 'gdhhd', 'david', 'dhd', '2014-11-20', NULL);
